...
//        #pragma message ("********************************  " __FILE__ " ***     Declaration Direction = dllexport")
  ...
  //
  __declspec(DIRECTION)  int   __stdcall SEPIA2_COM_GetFormatVersion          (int iDevIdx,     int   iSlotId,  int   iGetPrimary,   unsigned short* pwFormatVersion);
  ...
  __declspec(DIRECTION)  int   __stdcall SEPIA2_PRI_GetIntensity              (int iDevIdx,     int   iSlotId,  int    iWLIdx,          unsigned short* pwIntensity);
  __declspec(DIRECTION)  int   __stdcall SEPIA2_PRI_SetIntensity              (int iDevIdx,     int   iSlotId,  int    iWLIdx,          unsigned short wIntensity);
